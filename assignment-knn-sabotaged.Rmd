...
```{r}
new_occupancy_data$Occupancy <- factor(new_occupancy_data$Occupancy, levels = c("1", "0"), labels = c("Occupied", "Not Occupied")) %>% relevel ("Occupied")
...
```{r}
train_label <- new_occupancy_data[1:6526, 1]
test_label <- new_occupancy_data[6527:8143, 1]
```
